...
export const headers = [
    {
        ...
        avatar      : 'assets/images/flags/mexico.png',
        background  : 'assets/images/pago-backgroung.png',
        name        : 'ISO 8583 93 - Campanha Black Friday',
        version: 'Version 1.0',  
        ...
        types:          { id: 2, name: 'Authorization' },
        country:        { id: 2, name: 'México' },
        transaction:    { id: 1, name: 'AMEX-CREDIT' },
        status:         { id: 2, name: 'Production' },

    },
    {
        id          : 'cd5fa417-b667-482d-b208-798d9da3213d',
        avatar      : 'assets/images/flags/spanish.png',
        background  : 'assets/images/pago-backgroung.png',
        name        : 'ISO 8583 93 - Campanha Feliz Ano Novo',
        version: 'Version 1.0',  
        ...
        types:          { id: 2, name: 'Authorization' },
        country:        { id: 2, name: 'Spanish' },
        transaction:    { id: 1, name: 'AMEX-CREDIT' },
        status:         { id: 2, name: 'Homolog' },

    },
    {
        id          : 'cd5fa417-b667-482d-b208-798d9da3213s',
